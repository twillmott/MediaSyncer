...
public class SeasonActivity extends AppCompatActivity {
    ...
    private class RetrieveSeasonInfo extends AsyncTask<Void, Void, Void> {
        ...
        protected void onPostExecute(Void aVoid) {
            ...
            Picasso.with(SeasonActivity.this).load(url).into(imageView);
        }
    }
    ...
    public class SeasonSectionsPagerAdapter extends FragmentPagerAdapter {
        ...
        public Fragment getItem(int position) {
            ...
            switch (position) {
                case 0:
                    return SeasonOverviewFragment.newInstance(position);
                case 1:
                    return EpisodesFragment.newInstance(position);
